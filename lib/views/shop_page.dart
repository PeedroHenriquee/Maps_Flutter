...
class ShoppingPageState extends State<ShoppingPage> {
  ...
  final List<Marker> _markers = <Marker>[
    Marker(
      markerId: MarkerId('Shop da Cidade'),
      position: LatLng(-5.090986561159582, -42.81825721951354),
      infoWindow: InfoWindow(
        title: 'Shop da Cidade',
      ),
    ),
    Marker(
      markerId: MarkerId('Grand Dirceu Shopping'),
      position: LatLng(-5.107019972253844, -42.769507596372875),
      infoWindow: InfoWindow(
        title: 'Grand Dirceu Shopping',
